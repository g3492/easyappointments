...
$agn_providers  = Config::AGN_PROVIDERS;
$agn_the_provider  = Config::AGN_THE_PROVIDER;
$agn_the_providers  = Config::AGN_THE_PROVIDERS;
$agn_customer  = Config::AGN_CUSTOMER;
$agn_customers  = Config::AGN_CUSTOMERS;
$agn_the_customer  = Config::AGN_THE_CUSTOMER;
$agn_the_customers  = Config::AGN_THE_CUSTOMERS;

$lang['page_title'] = 'Agendar una cita con';
$lang['service_and_provider'] = "Seleccione {$agn_service} y {$agn_provider}";
$lang['select_service'] = "Seleccione {$agn_service}";
$lang['select_provider'] = "Seleccione {$agn_provider}";
...
$lang['cancel_appointment_hint'] = 'Presione el botón "Cancelar" para eliminar la cita de la agenda de la organización.';
...
$lang['reason'] = 'Razón';
$lang['appointment_removed_from_schedule'] = 'Se eliminó esta cita de la agenda de la organización.';
...
$lang['customer_details_title'] = "Detalles {$agn_customer}";
$lang['service'] = $agn_service ;
$lang['provider'] = $agn_provider;
$lang['customer'] = $agn_customer;
$lang['start'] = 'Inicio';
$lang['end'] = 'Final';
$lang['name'] = 'Nombre';
...
$lang['appointment_locked'] = 'No se puede modificar.';
$lang['appointment_locked_message'] = 'La cita no se puede cambiar, cuando faltan {$limit} horas o menos, para la misma.';
...
$lang['manage_appointment_record_hint'] = "Gestionar todos las citas agendadas de {$agn_providers} y {$agn_services} disponibles.";
...
$lang['unavailable_periods_hint'] = "El {$agn_provider} no podrá aceptar nuevas citas cuando se encuentre como No disponible.";
...
$lang['hide'] = 'Ocultar';
$lang['type_to_filter_customers'] = "Tipee para filtrar {$agn_customers}.";
$lang['clear_fields_add_existing_customer_hint'] = "Limpiar los campos e ingresar un nuevo {$agn_customer}.";
$lang['pick_existing_customer_hint'] = "Elegir {$agn_customer} existente.";
...
$lang['provider_saved'] = "{$agn_provider} guardado exitosamente";
$lang['secretary_saved'] = 'Asistente guardado exitosamente';
$lang['admin_deleted'] = 'Administador eliminado exitosamente';
$lang['provider_deleted'] = "{$agn_provider} eliminado exitosamente";
$lang['secretary_deleted'] = 'Asistente eliminado exitosamente';
$lang['service_saved'] = "{$agn_service} guardado exitosamente";
$lang['service_category_saved'] = "Categoría de {$agn_service} guardada exitosamente";
$lang['service_deleted'] = "{$agn_service} eliminado exitosamente";
$lang['service_category_deleted'] = "Categoría de {$agn_service} eliminada exitosamente";
$lang['customer_saved'] = "{$agn_customer} guardado exitosamente";
$lang['customer_deleted'] = "{$agn_customer} eliminado exitosamente";
...
$lang['add_breaks_during_each_day'] = "Agregar periodos de descanso para cada día. Durante los periodos de descanso {$agn_the_providers} no podrán aceptar ninguna cita.";
$lang['day'] = 'Día';
$lang['days'] = 'Días';
$lang['actions'] = 'Acciones';
$lang['reset_working_plan_hint'] = 'Restaurar el esquema del horario laboral a los valores por defecto.';
$lang['company_name'] = 'Nombre de la organización';
$lang['company_name_hint'] = 'El nombre de la organización aparecerá en todo el sistema (obligatorio).';
$lang['company_email'] = 'Dirección de E-mail de la organización';
$lang['company_email_hint'] = 'Esta será la dirección de E-mail de la organización. Será utilizada como la dirección para enviar E-mails del sistema y recibir respuestas (obligatorio).';
$lang['company_link'] = 'Enlace de la organización';
$lang['company_link_hint'] = 'El enlace de la organización debe dirigir al sitio web oficial de la organización (obligatorio).';
$lang['go_to_booking_page'] = 'Ir a la página para agendar';
$lang['settings_saved'] = 'Configuración guardada exitosamente';
$lang['general'] = 'General';
$lang['business_logic'] = 'Horarios generales';
$lang['current_user'] = 'Usuario actual';
$lang['about_app'] = 'Acerca de Este Servicio';
$lang['edit_working_plan_hint'] = "Marque abajo los días y horarios en que su organización aceptará citas. Será posible agendar citas fuera del horario de trabajo, pero {$agn_the_customers} no podrán agendar citas ellos mismos en esos horarios.  Este será el esquema del horario laboral por defecto para {$agn_the_providers} registrados, pero podrá cambiar el esquema de cada {$agn_provider} editando su registro. Luego se podrá agregar periodos de descanso.";
$lang['edit_breaks_hint'] = "Agrgar los periodos de descanso de trabajo en cada día. Se aplicarán estos periodos de descanso para todos los nuevos {$agn_providers}.";
...
$lang['about_app_license'] = 'Este Servicio se encuentra bajo licencia GPLv3. Todo tipo de uso del código de Este Servicio presume la aceptación de los términos desciptos en la siguiente dirección web:';
...
$lang['delete_customer'] = "Eliminar {$agn_customer}";
$lang['delete_service'] = "Eliminar {$agn_service}";
$lang['delete_category'] = "Eliminar Categoría de {$agn_service}";
$lang['delete_provider'] = "Eliminar {$agn_provider}";
...
$lang['ea_update_success'] = 'Este Servicio ha sido actualizado exitosamente';
$lang['require_captcha'] = 'Requiere CAPTCHA';
$lang['require_captcha_hint'] = "Cuando se habilita, {$agn_the_customer} tendrá que escribir el código CAPTCHA antes de reservar/actualizar una cita.";
$lang['captcha_is_wrong'] = 'Verificación de CAPTCHA fallida, por favor intentelo nuevamente.';
$lang['any_provider'] = "Cualquier {$agn_provider}";
...
$lang['customer_notifications'] = "Notificaciones de {$agn_customers}";
$lang['customer_notifications_hint'] = "Define si {$agn_the_customer} recibirá notificaciones de correo cada vez que una agenda cambia o alguna de sus citas.";
...
$lang['require_phone_number_hint'] = "Cuando está habilitado, {$agn_customers} y usuarios deberán ingresar el número de teléfono del {$agn_customer} al registrar una cita.";
$lang['check_spam_folder'] = 'Por favor, verifique su carpeta de correo no deseado si el correo no llega dentro de unos minutos.';
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API de Este Servicio.';
$lang['timezone'] = 'Zona horaria';
$lang['timezone_example'] = 'Zona horaria (ej.: Buenos_Aires)';
$lang['overwrite_existing_working_plans'] = "Esto sobreescribirá los planes de trabajo existentes del {$agn_provider}. ¿Seguro que desea continuar?";
$lang['working_plans_got_updated'] = 'Todos los planes de trabajo fueron actualizados.';
$lang['apply_to_all_providers'] = "Aplicar a todos {$agn_the_providers}";
$lang['display_any_provider'] = "Opción de mostrar cualquier {$agn_provider}";
$lang['display_any_provider_hint'] = "La página de reserva tendrá una opción adicional que permitirá que {$agn_the_customers} se anoten sin específicar {$agn_provider}.";
